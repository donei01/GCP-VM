...
with open('large.csv','r') as csvinput:
	with open('large_extended_1030.csv','w') as csvoutput:
		...
		row.extend(['RELATED_ACCT','RELATED_TYPE','PARTY_TYPE','PARTY_RELATION','PARTY_STARTDATE','PARTY_ENDDATE','LARGE_CASH_EXEMPT',\
				'DEMARKET_FLAG','DEMARKET_DATE','PROB_DEFAULT_RISKR','OFFICIAL_LANG_PREF','CONSENT_SHARING','PREFERRED_CHANNEL',\
				'PRIMARY_BRANCH_NO','CUSTOMER_STATUS','DEPENDANTS_COUNT','SEG_MODEL_ID','SEG_MODEL_TYPE','SEG_MODEL_NAME',\
				'SEG_MODEL_GROUP','SEG_M_GRP_DESC',\
